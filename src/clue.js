...
function selectRandom(param) {
  ...
  let numRandom = Math.random() * param.length
  let indexRandom = Math.floor(numRandom)
  let aleatorio =param[indexRandom]
  return aleatorio
}
//console.log(selectRandom(suspectsArray).firstName)
//console.log(selectRandom(suspectsArray).lastName)
//console.log(selectRandom(weaponsArray).name)
//console.log(selectRandom(roomsArray).name)
...
// estoy aquí atrancado y quiero intentar el de CSS, asi que si puedo lo intentaré más tarde.
